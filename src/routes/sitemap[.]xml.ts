...
const pages = [
  ...
  {
    path: "/services/mpesa-integrations",
    changefreq: "monthly",
    priority: "0.8",
    lastmod: LAST_MODIFIED,
  },
  ...
  {
    path: "/projects/retail-bookkeeping-platform",
    changefreq: "monthly",
    priority: "0.7",
    lastmod: LAST_MODIFIED,
  },
  {
    path: "/projects/fleet-management-system",
    changefreq: "monthly",
    priority: "0.7",
    lastmod: LAST_MODIFIED,
  },
  {
    path: "/projects/vaccination-tracker-system",
    changefreq: "monthly",
    priority: "0.7",
    lastmod: LAST_MODIFIED,
  },
  {
    path: "/projects/digital-file-document-management-system",
    changefreq: "monthly",
    priority: "0.7",
    lastmod: LAST_MODIFIED,
  },
  {
    path: "/projects/linkfy-service-marketplace-app",
    changefreq: "monthly",
    priority: "0.7",
    lastmod: LAST_MODIFIED,
  },
